...
ActiveRecord::Schema.define(version: 20140805012957) do
  ...
  add_index "admin_users_pages", ["admin_users_id", "page_id"], name: "index_admin_users_pages_on_admin_users_id_and_page_id", using: :btree
